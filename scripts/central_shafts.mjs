...
const LINE_DEPTH_M = 28; // heuristic fallback
...
// load anchors (may be empty for Central)
let anchors = new Map();
try {
...
await fs.mkdir('public/data/central', { recursive: true });
await fs.writeFile('public/data/central/shafts.json', JSON.stringify({
  line: LINE_ID,
  origin: ORIGIN,
  verticalScale,
  groundY,
