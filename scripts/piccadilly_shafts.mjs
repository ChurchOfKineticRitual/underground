...
const LINE_DEPTH_M = 28; // heuristic fallback (Piccadilly is deep)
...
// load anchors (may be empty for Piccadilly)
let anchors = new Map();
try {
...
await fs.mkdir('public/data/piccadilly', { recursive: true });
await fs.writeFile('public/data/piccadilly/shafts.json', JSON.stringify({
  line: LINE_ID,
  origin: ORIGIN,
  verticalScale,
  groundY,
